<template>     
  <section class="h-screen flex flex-col dark:bg-gray-950 text-white ">
    <header class="w-full text-white">
      <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <!-- Logo -->
        <div class="text-2xl font-bold  hidden sm:block">Ill</div>
        ...
        <button @click="isOpen = !isOpen"
          class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden ml-auto cursor-pointer">
        ...
        <nav :class="[
          ' md:hidden  ml-auto justify-between absolute right-10 top-15 ',
          isOpen ? 'block' : 'hidden'
        ]">
          <ul
    ...
    <div class="max-w-7xl mx-auto flex items-center justify-center px-6 py-4 flex-1 gap-46">
      ...
      <div class="space-y-4">
        ...
        <div class="flex gap-4">
          ...
          <a href="https://www.instagram.com/ismaellawrenz"
            class="h-10 w-10 bg-gray-800 flex items-center justify-center rounded-md hover:text-green-500 hover:border-green-500 border border-transparent">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
          ...
          <a href="https://github.com/ismaellawrenz"
            class="h-10 w-10 bg-gray-800 flex items-center justify-center rounded-md hover:text-green-500 hover:border-green-500 border border-transparent">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
      ...
      <div class="relative justify-center h-full items-end hidden sm:block">
        <img src="..\assets\images\me.png" alt="me" class="w-auto h-188" />
        <div class="absolute inset-0 bg-gradient-to-t from-gray-950/90 to-transparent"></div>
      </div>
    </div>
  ...
  <section id="projetos" class="min-h-screen flex flex-col items-center justify-center dark:bg-black gap-12 px-6 py-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl w-full">
      <!-- Card 1 -->
      <a href="https://github.com/ismaellawrenz/DiscordBot"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
          class="lucide lucide-bot mb-4 text-green-500">
          <path d="M12 8V4H8" />
      ...
      <a href="#"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
          class="lucide lucide-laptop-minimal-check mb-4 text-green-500">
          <path d="M2 20h20" />
      ...
      <a href="https://github.com/ismaellawrenz/todo-list-Angular"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
          class="lucide lucide-clipboard-check mb-4 text-green-500">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl w-full">
      ...
      <a href="https://github.com/Samuel-Oliveira/Java_CTe"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
          class="lucide lucide-github-icon lucide-github mb-4 text-green-500">
          <path
            d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4" />
          <path d="M9 18c-4.51 2-5-2-7-2" />
        </svg>
  ...
  <section id="habilidades" class="min-h-screen flex flex-col items-center justify-center dark:bg-gray-950 gap-12">
    ...
    <div class="grid grid-cols-2 md:grid-cols-5 gap-8">
      ...
      <div
        ...
        <svg viewBox="0 0 128 128" class="absolute invert brightness-0 w-30 h-30 object-contain opacity-10 ">
          <path fill="#0074BD"
        ...
        <span class="relative text-white font-semibold">JAVA</span>
      </div>
      <div
        class="relative w-40 h-40 bg-gray-600 rounded-xl flex items-center justify-center overflow-hidden hover:scale-115 hover:bg-gray-700 transition-transform">
        ...
        <svg viewBox="0 0 128 128" class="absolute invert brightness-0 w-30 h-30 object-contain opacity-10">
          <path
            d="m78.36 0 41.77 89.9 4.34-68.57L78.36 0M38.87 94.47l-6.42 15.54L64 128l31.55-17.99-6.42-15.54H38.87M80.53 74.3 64 34.11 47.47 74.3h33.06m-77-52.97L7.87 89.9 49.64 0 3.53 21.33">
          </path>
        </svg>

        <span class="relative text-white font-semibold">ANGULAR</span>
      </div>
      <div
        class="relative w-40 h-40 bg-gray-600 rounded-xl flex items-center justify-center overflow-hidden hover:scale-115 hover:bg-gray-700 transition-transform">
        <svg viewBox="0 0 128 128" class="absolute invert brightness-0 w-30 h-30 object-contain opacity-10">
        ...
        <span class="relative text-white font-semibold">SPRING</span>
      </div>
      <div
        class="relative w-40 h-40 bg-gray-600 rounded-xl flex items-center justify-center overflow-hidden hover:scale-115 hover:bg-gray-700 transition-transform">

        <svg viewBox="0 0 128 128" class="absolute invert brightness-0 w-30 h-30 object-contain opacity-10">
          <path fill-rule="evenodd" clip-rule="evenodd" fill="#336791"
        ...
        <span class="relative text-white font-semibold">POSTGRESQL</span>
      </div>
      <div
        class="relative w-40 h-40 bg-gray-600 rounded-xl flex items-center justify-center overflow-hidden hover:scale-115 hover:bg-gray-700 transition-transform">
        ...
        <span class="relative text-white font-semibold">VUE</span>
      </div>
      <div
        class="relative w-40 h-40 bg-gray-600 rounded-xl flex items-center justify-center overflow-hidden hover:scale-115 hover:bg-gray-700 transition-transform">
        ...
        <span class="relative text-white font-semibold">GOLANG</span>
      </div>
      <div
        class="relative w-40 h-40 bg-gray-600 rounded-xl flex items-center justify-center overflow-hidden hover:scale-115 hover:bg-gray-700 transition-transform">
        ...
        <span class="relative text-white font-semibold">TYPESCRIPT</span>
      </div>
      <div
        class="relative w-40 h-40 bg-gray-600 rounded-xl flex items-center justify-center overflow-hidden hover:scale-115 hover:bg-gray-700 transition-transform">
        ...
        <span class="relative text-white font-semibold">MYSQL</span>
      </div>
      <div
        class="relative w-40 h-40 bg-gray-600 rounded-xl flex items-center justify-center overflow-hidden hover:scale-115 hover:bg-gray-700 transition-transform">
        ...
        <span class="relative text-white font-semibold">AWS</span>
      </div>
    </div>
  </section>
  ...
  <section id="contato"
    ...
    <div class="flex gap-4">
      <a href="https://www.linkedin.com/in/ismael-luan-lawrenz-406259224"
        class="h-15 w-15 bg-gray-800 flex items-center justify-center rounded-lg hover:text-green-500 hover:border-green-500 border border-transparent">
      ...
      <a href="https://www.instagram.com/ismaellawrenz"
        class="h-15 w-15 bg-gray-800 flex items-center justify-center rounded-md hover:text-green-500 hover:border-green-500 border border-transparent">
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
          class="lucide lucide-instagram-icon lucide-instagram">
          <rect width="20" height="20" x="2" y="2" rx="5" ry="5" />
      ...
      <a href="https://github.com/ismaellawrenz"
        class="h-15 w-15 bg-gray-800 flex items-center justify-center border rounded-md hover:text-green-500 hover:border-green-500 border-transparent">
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
          class="lucide lucide-github-icon lucide-github ">
          <path
...
.typing {
  ...
  /* cursor */
  animation: typing 3s steps(22, end) forwards, blink 0.8s step-start 3s infinite;
}
